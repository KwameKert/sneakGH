        ...
        $('.sa-warning').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    type:'POST',
                    data: {'id':id,'action':'reverse_transaction'},
                    success:function(text){
                        if(text ==1 ){
                         swal(
                            'Retracted!',
                            'Your transaction will be reversed to you.',
                            'success'
                        )
        ...
        $('.retract').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    url: '../controllers/transaction.controller.php',
                    type:'POST',
                    data: {'id':id,'action':'refund_transaction'},
                    success:function(text){
                        if(text ==1 ){
                         swal(
                            'Retracted!',
                            'Your transaction will be refunded to client.',
                            'success'
                        )
                         location.reload(true);
                        }else{
        ...
        $('.approve').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    url: '../controllers/transaction.controller.php',
                    type:'POST',
                    data: {'id':id,'action':'approve_transaction'},
                    success:function(text){
                        if(text ==1 ){
                         swal(
                            'Retracted!',
                            'Your transaction will be approved to client.',
                            'success'
                        )
                         location.reload(true);
                        }else{
